...
single_nat_gateway = true # Set to true for cost optimization (not recommended for prod)
enable_flow_logs   = true

# Security Configuration - IMPORTANT: Replace with your IP address
# Get your IP: curl ifconfig.me
allowed_cidr_blocks = [
  "82.9.28.197/32" # Replace with your IP address, e.g., "203.0.113.1/32"
]
...
max_capacity  = 3 # Maximum tasks for auto-scaling

# Auto Scaling Configuration
cpu_target_value    = 70 # Scale when CPU > 70%
memory_target_value = 70 # Scale when Memory > 80%
